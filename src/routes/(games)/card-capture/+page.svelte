...
<GamePage title="CARD CAPTURE">
	...
	<p>
		Card Capture is a solitaire card game designed by <Link
	...
	<p>
		In Card Capture, you are a monster exterminator hired by the King to rid his castle of pesky
		beasts. As you tread through the dark and dingy dungeon cells, monsters will appear. Beat them
		down with a powerful attack and wipe them out using their weakness against them. Exterminate the
		monsters before running out of power and victory will be yours.
	</p>
	<h2 class="text-5xl font-bold">Rules</h2>
	<h3 class="text-4xl font-bold">Materials</h3>
	<p>
		Card Capture requires a fifty-four card deck: aces up through kings in four suits as well as two
		jokers.
	</p>
